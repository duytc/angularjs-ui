        ...
        .provider('CONNECT_DATA_SOURCE_TYPE_FORMAT_ALL_FIELD', {
            $get: function (CONNECT_DATA_SOURCE_TYPE_FORMAT_ALL_FIELD_KEY) {
                return [
                    ...
                    {key: CONNECT_DATA_SOURCE_TYPE_FORMAT_ALL_FIELD_KEY.addConditionValue, label: 'Add Condition Value'},
                    ...
                    {key: CONNECT_DATA_SOURCE_TYPE_FORMAT_ALL_FIELD_KEY.addFieldFromDate, label: 'Add Date Field'}
                ];
            }
        })
