(function () {
    ...
    function NewValueForm($scope, $modalInstance, Auth, value, dateUtil, dimensionsMetrics, reportBuilder, listValues, fields, transform, ReportViewAddConditionalTransformValues, COMPARISON_TYPES_ADD_FIELD_VALUE) {
        ...
        if($scope.isNew && isAdmin) {
            $scope.value.publisher = angular.isObject(reportBuilder.publisher) ? reportBuilder.publisher.id : reportBuilder.publisher
        }
