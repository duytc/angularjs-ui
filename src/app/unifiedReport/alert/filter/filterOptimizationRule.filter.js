(function () {
    ...
    angular.module('tagcade.blocks.misc')
        .filter('filterOptimizationRule', filterOptimizationRule)
    ;

    function filterOptimizationRule(Auth) {
        return function (items, publisherId) {
            ...
            angular.forEach(items, function (item) {
                ...
                try {
                    ...
                    if (item.id == null || publisherId === item.optimizationRule.publisher.id) {
                        filtered.push(item);
                    }
                } catch (e) {
                }
