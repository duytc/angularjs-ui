(function() {
    ...
    angular.module('tagcade.videoManagement')
        ...
        .constant('REQUIRED_MACROS_OPTIONS', [
            ...
            {label: "demand_sell_price", key: "demand_sell_price", root: '${demand_sell_price}', helpText: 'The sell price of demand tag, only for "Fire On" is Impression in IVT Pixel'}
        ])
