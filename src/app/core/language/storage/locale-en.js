    ...
    angular.module("tagcade.core.language")
        .constant("LOCALE_EN", {
            ...
            "AUTO_OPTIMIZE_INTEGRATION_MODULE": {
                ...
                "GENERAL_MESSAGE_HELP": "This configuration helps to filter data for building an optimization model. It will be more accurate if your data is more recent to current date.",
                ...
                "DISABLE_EDIT_REPORT_VIEW": "This report view is current being used by an optimization rule. It temporarily can not be edited.",
