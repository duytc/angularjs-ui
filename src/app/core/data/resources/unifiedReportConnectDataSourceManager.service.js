(function () {
    ...
    angular.module('tagcade.core.data.resources')
        .factory('UnifiedReportConnectDataSourceManager', UnifiedReportConnectDataSourceManager)
    ;

    function UnifiedReportConnectDataSourceManager(unifiedReportRestangular) {
        var RESOURCE_NAME = 'connecteddatasources';
