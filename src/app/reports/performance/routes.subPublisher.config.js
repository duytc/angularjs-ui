(function() {
    ...
    function addStates($stateProvider) {
        $stateProvider
            .state('app.subPublisher.reports.performance.account', {
        ...
        $stateProvider
            .state('app.subPublisher.reports.performance.adNetworks', {
        ...
        $stateProvider
            .state('app.subPublisher.reports.performance.sites', {
        ...
        $stateProvider
            .state('app.subPublisher.reports.performance.adNetworksSubPublishers', {
        ...
        $stateProvider
            .state('app.subPublisher.reports.performance.adNetworkSiteSubPublishers', {
