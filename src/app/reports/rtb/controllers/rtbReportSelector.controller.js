(function() {
    ...
    function RtbReportSelector($scope, $translate, $q, $state, _, PERFORMANCE_REPORT_TYPES, Auth, UserStateHelper, AlertService, rtbReport, reportSelectorForm, ReportParams) {
        ...
        var reportTypeOptions = [
            {
                ...
                label: 'Account',
                toState: 'reports.rtb.account'
            },
            {
                key: PERFORMANCE_REPORT_TYPES.site,
                breakdownKey: 'siteBreakdown',
                label: 'Site',
                toState: 'reports.rtb.sites',
                visibleFields: [reportFields.site],
                breakdownOptions: [
                    {
                        key: 'day',
                        label: 'By Day',
                        toState: 'reports.rtb.site'
                    },
                    {
                        key: 'adslot',
                        label: 'By Ad Slot',
                        toState: 'reports.rtb.siteAdSlots'
                    }
                ]
            },
            {
                ...
                label: 'Ad Slot',
                toState: 'reports.rtb.adSlots',
                visibleFields: [reportFields.site, reportFields.adslot],
                breakdownOptions: [
                    {
                        key: 'day',
                        label: 'By Day',
                        toState: 'reports.rtb.adSlot'
                    }
                ]
            },
            {
                ...
                breakdownOptions: [
                    {
                        key: 'day',
                        label: 'By Day',
                        toState: 'reports.rtb.ronAdSlot'
                    },
                    {
                        key: 'segment',
                        label: 'By Segment',
                        toState: 'reports.rtb.ronAdSlotSegments'
                    },
                    //{
                    //    key: 'site',
                    //    label: 'By Site',
                    //    toState: 'reports.rtb.ronAdSlotSites'
                    //}
                    //{
                    //    key: 'adtag',
                    //    label: 'By Ad Tag',
                    //    toState: 'reports.rtb.ronAdSlotAdTags'
                    //}
                ]
            }
        ];
            ...
            reportTypeOptions.unshift({
                ...
                breakdownOptions: [
                    ...
                    },
                    {
                        key: 'account',
                        label: 'By Account',
                        toState: 'reports.rtb.platformAccounts'
                    },
                    {
                        key: 'site',
                        label: 'By Site',
                        toState: 'reports.rtb.platformSites'
                    }
                ]
            });
        }
        ...
        function getAdSlot(siteId) {
            if(hasGetAdSlot && toState != 'reports.rtb.adSlots') {
                return
            }
...
//                        addAllOption(adSlots, 'All AdSlots');
        ...
        function update() {
            var params = ReportParams.getFormParams(rtbReport.getInitialParams());
