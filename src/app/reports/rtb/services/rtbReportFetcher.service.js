(function(angular) {
    ...
    angular.module('tagcade.reports.rtb')
        .factory('rtbReportFetcher', rtbReportFetcher)
    ;

    function rtbReportFetcher($q, API_RTB_REPORTS_BASE_URL, dataService, dateUtil) {
        var api = {
        ...
        function getReports(url, params) {
            ...
            return dataService.makeHttpGetRequest(url, params, API_RTB_REPORTS_BASE_URL);
        }
