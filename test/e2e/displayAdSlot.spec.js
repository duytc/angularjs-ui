describe("Display Ad Slots Test", function() {
    ...
    it('should create Display Ad Slots successfully although too long name', function() {
        browser.get(browser.params.role + '/tagManagement/adSlots/new');
        ...
        name.sendKeys('displayAdSlot-test' + tagcadeTestUtil.getDateString(new Date()) + '-qwertyuiopasdfghjklzxcvbnmqwertyuiopasdfghjklzxcvbnmqwertFFFFFFFFFF');
        width.sendKeys('100');
        height.sendKeys('200');
    ...
    it('should update Display Ad Slots successfully', function() {
        browser.get(browser.params.role + '/tagManagement/adSlots/edit/' + browser.params.edit.displayAdSlotId);
